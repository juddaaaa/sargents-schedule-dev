class CompletedBatch extends Batch {
    ...
    append() {
        ...
        if (!this.exists()) {
            sheet.appendRow([this.batch, this.group, this.description, this.qty, this.timestamp])
    ...
    exists() {
        ...
        if (sheet.createTextFinder(this.batch).findNext()) {
            return true
        }
    ...
    push(array) {
        ...
        array.push([this.batch, this.group, this.description, this.qty, this.timestamp])
