class Schedule {
    ...
    static create(name) {
        ...
        sheet.getRange('B2:P2').merge().setFontSize(40).setHorizontalAlignment('right').setValue('Statics 1st Fix')
        sheet.getRange('B3:P3').merge().setFontSize(40).setHorizontalAlignment('right').setValue(`${name} Schedule`)
        ...
        sheet.getRange('K5:O5').merge().setBackground('#38761D').setValue('Progress')
        ...
        sheet.getRange(`E6:E${sheet.getMaxRows()}`).setHorizontalAlignment('left').setNumberFormat('   @')
        sheet.getRange('G6:H6').setHorizontalAlignment('left').setNumberFormat('   @')
